...
`visibility` at the package root; the Encounter ceremony's transmission
**left on 05.09.2026** and lives under `ceremony`. Experiment with the rest; do not treat its wire forms
