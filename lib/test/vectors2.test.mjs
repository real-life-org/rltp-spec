...
test('visibility — the artifact set is complete and well-formed', () => {
  ...
  // which is exactly what the four simulator suites do — and CI runs
  // those against the BUILT library (scripts/probe-equivalence.mjs).
